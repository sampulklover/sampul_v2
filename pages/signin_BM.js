      ...
      <div class="row">
        <div class="col-lg-4 px-5 py-5">
          <h2 class="uui-heading-medium-10">
            <strong class="smpl-heading-large fw-semibold">Log masuk</strong>
          </h2>
          <div class="uui-space-xsmall-3"></div>
          <div class="smpl-text-size-large">
            Selamat datang kembali, masukkan butiran anda.
          </div>
          <div class="mt-5">
            <form class="mb-3" onSubmit={onSubmitNormalLogin}>
              ...
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-text">
                  <Loading title="Log masuk" loading={isLoading.normal_login} />
                </button>
              </div>
            </form>
            <div class="d-grid gap-2">
            ...
            <p class="text-center mt-4">
              Tiada Akaun?{' '}
              <Link href="signup_BM" style={{ textDecoration: 'none' }}>
                <strong class="text-primary">Daftar</strong>
              </Link>
            </p>
          </div>
        </div>
